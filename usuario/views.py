...
from usuario.forms import MiFormularioDeCreacionDeUsuarios, MiFormularioDeEdicionDeDatosUsuario
...
def editar_perfil(request): 
    ...
    if request.method == 'POST':
        ...
        formulario = MiFormularioDeEdicionDeDatosUsuario(initial ={'avatar':info_extra_user.avatar}, instance=request.user)
